...
[![Mozilla Add-on](https://img.shields.io/amo/users/open-in-popup-window?color=%23FF6611&label=users&logo=Firefox-Browser)](https://addons.mozilla.org/firefox/addon/open-in-popup-window/)
...
- [x] Several ways to open a popup window: 
    ...
    - [x] Click on toolbar icon (search or open current page in popup)
